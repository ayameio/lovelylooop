	...
	return (
		<div className={`relative w-full h-screen ${rubik.className}`}>
			...
			<div className="relative z-10 flex flex-col items-center justify-center h-full px-4 md:px-6 lg:px-8 gap-4">
				...
				<p className="mt-6 h-6 rounded-xl bg-white font-bold text-center text-lg text-black flex flex-row justify-center items-center text-sm p-4 shadow-[0_0_20px_rgba(0,0,0,0.5)] bg-black/50 text-white">Token Address</p>
